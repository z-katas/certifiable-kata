# Grading consitency checks

## Use Case & Problem Statement
- **Primary Goals:** HMW implement AI-based consistency checks for expert architects so that grading discrepancies are minimized across multiple reviewers?
- **Scope:**
- **Current Challenges:**
