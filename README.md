...
**Solution approach:** 
- The generaton of new questions in test 1 and case studies in test 2 can be automated using a **web search + RAG LLM architecture pattern** ([**ADR-004**](/ADRs/004-adr-new-questions-and-case-studies-strategy.md)).
-  Latest architecture techniques, patterns and trends are ingested with targeted web search and stored in a vector store following **semantic chunking**([**ADR-006**](/ADRs/006-adr-architecture-knowledge-chunking-strategy.md)).
